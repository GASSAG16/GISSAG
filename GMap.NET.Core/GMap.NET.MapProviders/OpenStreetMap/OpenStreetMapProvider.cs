...
namespace GMap.NET.MapProviders
{
   ...
   public abstract class OpenStreetMapProviderBase : GMapProvider, RoutingProvider, GeocodingProvider
   {
      ...
      //public MapRoute GetTransit(PointLatLng start, PointLatLng end, bool avoidHighways, int Zoom)

      //   //public MapRoute GetRoute(PointLatLng start, PointLatLng end, bool avoidHighways, bool walkingMode, int Zoom)
      //{
      //    List<PointLatLng> points = GetTransitPoints(MakeRoutingUrl(start, end, transit ? TravelTypeFoot : TravelTypeMotorCar));
      //    MapRoute route = points != null ? new MapRoute(points, walkingMode ? WalkingStr : DrivingStr) : null;
      //    return route;
      //}
