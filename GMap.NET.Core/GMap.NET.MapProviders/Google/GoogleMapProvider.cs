...
namespace GMap.NET.MapProviders
{
    ...
    public abstract class GoogleMapProviderBase : GMapProvider, RoutingProvider, GeocodingProvider, DirectionsProvider
    {
        ...
        //public MapRoute GetRoute(PointLatLng start, PointLatLng end, bool avoidHighways, bool transit, int Zoom)
        //{
        //    string tooltip;
        //    int numLevels;
        //    int zoomFactor;
        //    MapRoute ret = null;
        //    List<PointLatLng> points = GetRoutePoints(MakeRouteUrl(start, end, LanguageStr, avoidHighways, transit), Zoom, out tooltip, out numLevels, out zoomFactor);
        //    if (points != null)
        //    {
        //        ret = new MapRoute(points, tooltip);
        //    }
       ...
       //// public MapRoute GetRoute(string start, string end, bool avoidHighways, bool walkingMode,bool transit, int Zoom)
       // {
       //     string tooltip;
       //     int numLevels;
       //     int zoomFactor;
       //     MapRoute ret = null;
       //     List<PointLatLng> points = GetRoutePoints(MakeRouteUrl(start, end, LanguageStr, avoidHighways, walkingMode,transit), Zoom, out tooltip, out numLevels, out zoomFactor);
       //     if (points != null)
       //     {
       //         ret = new MapRoute(points, tooltip);
       //     }
       ...
       // }
        ...
        //public MapRoute GetRoute(string start, string end, bool avoidHighways, bool transit, int Zoom)
        //{
        //    string tooltip;
        //    int numLevels;
        //    int zoomFactor;
       ...
       //-------------------------------------------------------------------
        ...
        //string MakeRouteUrl(PointLatLng start, PointLatLng end, string language, bool avoidHighways, bool transit)
        //{
        //    string opt = transit ? WalkingStr : (avoidHighways ? RouteWithoutHighwaysStr : RouteStr);
        //    return string.Format(CultureInfo.InvariantCulture, RouteUrlFormatPointLatLng, language, opt, start.Lat, start.Lng, end.Lat, end.Lng, Server);
        //}

        //string MakeRouteUrl(string start, string end, string language, bool avoidHighways, bool transit)
        //{
        //    string opt = transit ? WalkingStr : (avoidHighways ? RouteWithoutHighwaysStr : RouteStr);
        //    return string.Format(RouteUrlFormatStr, language, opt, start.Replace(' ', '+'), end.Replace(' ', '+'), Server);
        //}
