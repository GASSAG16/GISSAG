namespace GMap.NET.WindowsForms
{
    ...
    [System.Serializable]
#if !PocketPC
    public class GMapCircle : MapRoute, ISerializable, IDeserializationCallback, IDisposable
#else
   public class GMapCircle : MapRoute, IDisposable
#endif
    {
      ...
      public static readonly Brush DefaultFill = new System.Drawing.SolidBrush(Color.AliceBlue);
        ...
        public GMapCircle(List<PointLatLng> points, string name)
            : base(points, name)
        {
        ...
        protected GMapCircle(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
